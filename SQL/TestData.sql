...
(4, 'Pikachu', 'Electric', NULL, 35, 55, 40, 50, 50, 90, 0, 'It keeps its tail raised to monitor surroundings.'),
(5, 'Raichu', 'Electric', NULL, 60, 90, 55, 90, 80, 110, 0, 'Its tail discharges electricity into the ground.'),
(6, 'Mewtwo', 'Psychic', NULL, 106, 110, 90, 154, 90, 130, 1, 'It was created by a scientist after years of horrific gene splicing.');
...
(6, 4, 'CloneGod', 0, 1, 70, 1),  -- On team + Showcased
(3, 4, 'Bulky', 1, 1, 42, 1),     -- On team + Showcased
(4, 4, 'Zaps', 0, 1, 35, 0),      -- On team
(5, 4, 'Zoomer', 0, 1, 55, 1),    -- On team + Showcased
...
INSERT INTO MyPokemon (pid, uid, nickname, favourite, onteam, level, showcase) VALUES
(4, 5, 'Sparkles', 1, 0, 18, 0),  -- Favourite
